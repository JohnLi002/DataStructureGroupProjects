...
public class Problem1Answers {
	public static void main(String[] args) {
		 ...
		 * 
		 * 	3.	Create a class Name as in lab 8, make it comparable by comparing just first names, then create a binary search 
		 * 		tree out of names in the provided file names.txt. 
